...
function loadFont(fontName) {
    return __awaiter(this, void 0, void 0, function* () {
        if (fontName == null) {
            yield figma.loadFontAsync({ family: "PingFang SC", style: "Regular" });
            yield figma.loadFontAsync({ family: "PingFang SC", style: "Semibold" });
            yield figma.loadFontAsync({ family: "PingFang SC", style: "Thin" });
            yield figma.loadFontAsync({ family: "PingFang SC", style: "Light" });
            yield figma.loadFontAsync({ family: "PingFang SC", style: "Medium" });
        }
        else {
